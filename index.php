...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        // DHIS2 connection details (use standard DHIS2 API path)
        $url = "https://monitoring.jocsoft.net/api/trackedEntityInstances";
        $username = "admin";
        ...
        if ($curl_error) {
            ...
            $error_message = "❌ Failed to save data. URL: $url. HTTP Code: $httpcode. Response: " . htmlspecialchars($response);
        }
    }
}
?>
