<?php
// --- CONFIGURATION --- //
$dhis_url = "https://monitoring.nacada.go.ke/api/programs/GWCzg7No8YJ?fields=name,shortName,programStages[id,name,programStageDataElements[dataElement[id,name,formName,code,valueType,optionSet[id,name,options[id,code,name]]]]]";
// DHIS2 credentials
$username = "admin";
    ...
    <div class="mt-3">
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($status == 200 || $status == 201) {
                echo "<div class='alert alert-success text-center mt-3'>Test submitted successfully!</div>";
            } else {
