...
<body>
    <div class="container">
        <header>
            <h1>PRE-TEST: WORKPLACE BASED PREVENTION INTERVENTIONS</h1>
            <p>Complete this pre-test assessment to evaluate your knowledge on workplace substance use prevention</p>
        </header>
        
        <div class="form-container">
            <div class="info-box">
                <div class="info-icon">ℹ️</div>
                <div>Please provide your email address and answer all questions to complete the pre-test assessment.</div>
            </div>
            ...
            <form method="POST">
                ...
                <div class="form-section">
                    <h3 class="section-title">Pre-Test Questions</h3>
                    
                    <div class="form-group">
                        <label for="result_of">PRT - The most widely used illicit substance in the world is:</label>
                    ...
                    <div class="form-group">
                        <label for="get_result_of">Alcohol or drug use is the result of:</label>
                        <select name="get_result_of" id="get_result_of">
