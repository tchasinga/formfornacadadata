...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['participant_name'])) {
    ...
    // API credentials
    $trackerUrl = "https://monitoring.nacada.go.ke/api/tracker";
    ...
    $dataValues = [
		...
		["dataElement" => "F1QpX9KI517", "value" => 1], //training category 
		["dataElement" => "K8R16S9ar48", "value" => 1], //type of training
		["dataElement" => "ASr7pZ5LlnB", "value" => 319032911], //id number
        ["dataElement" => "nVizQevhN5N", "value" => $tbf_mobile_number],
        ["dataElement" => "drOy4d20j1q", "value" => 1], // mode of training
        ["dataElement" => "C5itiQeAtSG", "value" => $currentDate], //end date
        [
...
<body>
  <div class="container">
    <h3 style="text-align:center">INDIVIDUAL BOOKING DETAILS</h3>
